...
<head>
    ...
    <title>{{ $title }}</title>
    <link rel="shortcut icon" href="{{ url('pendidikan.png') }}" type="image/x-icon">
    ...
    <div class="wrapper">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        <a href="{{ url('#') }}" class="dropdown-item">
                            <!-- Message Start -->
                            <div class="media">
                                <img src="{{ url('pendidikan.png') }}" alt="User Avatar"
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="{{ url('#') }}" class="brand-link">
                <img src="{{ url('pendidikan.png') }}" alt="AdminLTE Logo"
                    class="brand-image img-circle elevation-3" style="opacity: .8">
                <span class="brand-text font-weight-light">Rekapitulasi </span>
            </a>
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        @if (Auth::user()->user_jab_id == '1')
                            <li
                                class="nav-item {{ Request::is('main/mapel*') || Request::is('main/sekolah*') || Request::is('main/guru*') ? 'menu-open' : '' }}">
                                <a href="#"
                                    class="nav-link {{ Request::is('main/mapel*') || Request::is('main/sekolah*') || Request::is('main/guru*') ? 'active' : '' }}">
                                ...
                                <ul class="nav nav-treeview">
                                    ...
                                    <li class="nav-item">
                                        <a href="{{ url('main/sekolah') }}"
                                            class="nav-link {{ Request::is('main/sekolah*') ? 'active' : '' }}">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>
                                                Data sekolah
                                            </p>
                                    ...
                                    <li class="nav-item">
                                        <a href="{{ url('main/guru') }}"
                                            class="nav-link {{ Request::is('main/guru*') ? 'active' : '' }}">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>
                                                Data guru
                                            </p>
                            ...
                            {{-- Pendataan Nilai --}}
                            <li
                                class="nav-item {{ Request::is('main/penilaian/ditolak*') || Request::is('main/penilaian') || Request::is('main/penilaian/diterima*') ? 'menu-open' : '' }}">
                                <a href="#"
                                    class="nav-link {{ Request::is('main/penilaian/ditolak*') || Request::is('main/penilaian') || Request::is('main/penilaian/diterima*') ? 'active' : '' }}">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item ">
                                        <a href="{{ url('main/penilaian/') }}"
                                            class="nav-link {{ Request::is('main/penilaian') ? 'active' : '' }}">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>
                                                Menunggu Konfirmasi
                                            </p>
                                    ...
                                    <li class="nav-item">
                                        <a href="{{ url('main/penilaian/diterima') }}"
                                            class="nav-link {{ Request::is('main/penilaian/diterima*') ? 'active' : '' }}">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>
                                                Diterima
                                            </p>
                                    ...
                                    <li class="nav-item">
                                        <a href="{{ url('main/penilaian/ditolak') }}"
                                            class="nav-link {{ Request::is('main/penilaian/ditolak*') ? 'active' : '' }}">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>
                                                Ditolak
                                            </p>
                            ...
                            {{-- Laporan per tanggal  --}}
                            <li class="nav-item {{ Request::is('main/laporan/rekap*') ? 'menu-open' : '' }}">
                                <a href="#"
                                    class="nav-link {{ Request::is('main/laporan/rekap*') ? 'active' : '' }}">
        ...
        <footer class="main-footer">
            <strong>Copyright &copy; {{ date('Y') }} <a href="#">Rekapitulasi</a>
                ||</strong>
            Suportby Rekapitulasi Kekurangan Dan Kelebihan Data Guru ASN Per Mata Pelajaran.
